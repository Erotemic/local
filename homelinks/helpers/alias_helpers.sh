...
alias kdk='cd $HOME/code/kwcoco_detector_kit'
alias kwe='cd $HOME/code/kwcoco_explorer'
#alias kwd='cd $HOME/code/kwcoco_dataloader'
alias kwd='cd $HOME/code/kwcoco_detector_kit/tpl/kwcoco_dataloader'
...
alias kwx='cd $HOME/code/kwimage_ext'
