...
class TreeModel(QtCore.QAbstractItemModel):
    ...
    def rowCount(self, parent=QtCore.QModelIndex()):
        ''' ESSENTIAL OVERLOAD READ
        Returns: number of rows under the given parent.
    ...
    def index(self, row, column, parent=QtCore.QModelIndex()):
        ''' ESSENTIAL OVERLOAD READ
        Returns: index of the item in the model specified by row, column, parent index.
        When reimplementing this function in a subclass, call createIndex() to generate model
    ...
    def parent(self, index=None):
        ''' ESSENTIAL OVERLOAD
        Returns: parent of the model item with the given index.
        ...
        column of the returned QModelIndex would be 0. When reimplementing
        this function in a subclass, be careful to avoid calling QModelIndex
        member functions, such as QModelIndex::parent(), since indexes belonging
        to your model will simply call your implementation, leading to infinite recursion.
        '''        
    ...
    insertRows(), removeRows(), insertColumns(),and removeColumns(). When implementing these functions,
    it is important to notify any connected views about changes to the model's dimensions both before
