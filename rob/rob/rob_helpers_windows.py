...
def __nav_pane():  # Setup windows explorer sidebar
    registry.set_key_value(regkey('NAVBAR_HG'),
                           'Attributes', 'b084010c', 'DWORD')
    registry.set_key_value(regkey('NAVBAR_LIB'),
                           'Attributes', 'b080010d', 'DWORD')
    registry.set_key_value(regkey('NAVBAR_COMP'),
                           'Attributes', 'b094010c', 'DWORD')
    registry.set_key_value(regkey('NAVBAR_NET'),
                           'Attributes', 'b0040064', 'DWORD')
...
def __cmd_fonts():  # Get opendyslexic working in cmd
    ...
    registry.set_key_value(regkey('TRUE_FONT'), '0000',
                           'Mono Dyslexic Regular', 'SZ')
    registry.set_key_value(regkey('TRUE_FONT'), '00000',
                           'Mono Dyslexic', 'SZ')
    registry.set_key_value(regkey('TRUE_FONT'),
...
def regkey(key):  # List of registry keys for easy access
    ...
    k.NAVBAR_HG = HCR + \
        r'\CLSID\{B4FB3F98-C1EA-428d-A78A-D1F5659CBA93}\ShellFolder'
    k.NAVBAR_LIB = HCR + \
        r'\CLSID\{031E4825-7B94-4dc3-B131-E946B44C8DD5}\ShellFolder'
    k.NAVBAR_COMP = HCR + \
        r'\CLSID\{20D04FE0-3AEA-1069-A2D8-08002B30309D}\ShellFolder'
    k.NAVBAR_NET = HCR + \
        r'\CLSID\{F02C1A0D-BE21-4350-88B0-7367FC96EF3C}\ShellFolder'
