...
class ROB_Directories:
    ...
    def build_paths(d):
        ...
        d.INSTALL_32    = d.ROOT + slash_fix('/Program Files (x86)')
        d.INSTALL_64    = d.ROOT + slash_fix('/Program Files')


        d.VIM_BIN       = d.INSTALL_32  + slash_fix('/Vim/vim73')
        d.GIT_BIN       = d.INSTALL_32  + slash_fix('/Git/bin')
        d.VLC_BIN       = d.INSTALL_32  + slash_fix('/VideoLAN/VLC')
...
class ROB_Files:
    def __init__(f, d):
        ...
        f.winedt_exe  = d.INSTALL_32 + slash_fix('/WinEdt Team/WinEdt 7/WinEdt.exe')
        f.rap_ee_exe  = d.PORT_APPS  + slash_fix('/RapidEnvirornmentEditor/RapidEE.exe')
        f.qiqqa_exe   = d.INSTALL_32 + slash_fix('/Qiqqa/Qiqqa.exe')


        f.spotify_exe =  d.INSTALL_32 + slash_fix('/spotify.exe')
...
class ROB:
    def __init__(r):
        ...
        VIM_LOCAL = r.d.INSTALL_32  + slash_fix('/Vim')
